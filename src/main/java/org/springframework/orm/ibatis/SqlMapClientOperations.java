 ...
 * {@link com.ibatis.sqlmap.client.SqlMapExecutor}'s execution methods. Users are strongly encouraged to read the iBATIS
...
public interface SqlMapClientOperations {
  ...
  /**
   * Convenience method provided by Spring: execute an update operation with an automatic check that the update affected
   * the given required number of rows.
   *
   * @param statementName
  ...
  /**
   * Convenience method provided by Spring: execute a delete operation with an automatic check that the delete affected
   * the given required number of rows.
   *
   * @param statementName
   *          the name of the mapped statement
